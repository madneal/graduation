...
This paper mainly studies the sampling strategy of estimation of distribution algorithm. Inspired by differential evolution, this paper proposes a sampling strategy based on differential evolution, namely DES. And this strategy is utilized in estimation of distribution algorithm to study its performance. This paper combines differential evolution sampling strategy with estimation of distribution algorithm, and study its performance on single objective problems and multiobjective problems respectively. According to the comprehensive experimental analysis, it can be seen that differential evolution sampling strategy is impressively significant to improve the sampling of estimation of distribution algorithm.

The main contents of this paper are single objective estimation of distribution algorithm and multiobjective estimation of distribution algorithm based on DES. For single objective optimization problems, based on the framework of DE/EDA, utilize a differential evolution based on eigenvector to sample. Meanwhile, expensive local search is applied to improve the quality of solutions. Hence, single objective estimation of distribution algorithm is proposed. On the other hand, for multiobjective optimization problems, utilize DES to improve the sampling of RM-MEDA and obtain positive results. This paper applies DES to single objective estimation of distribution algorithm and multiobjective estimation of distribution algorithm. The comprehensive and systematic experimental analysis indicates the significance of differential evolution sampling strategy in estimation of distribution algorithm.

...
{\bf 针对多目标优化问题的差分进化算法：}得益于差分进化的简单但却强大的特点，差分进化同时也得到了多目标研究学者的广泛关注。 Chang等人第一次将差分进化拓展用于解决多目标优化问题~\cite{demo1999}。Abbas和Sarkar提出了帕累托差分进化算法（PDE）通过连续变量来解决多目标优化问题~\cite{pde2002}，并且这个算法在和其它多目标优化算法相比具有很大的竞争力。

...
\vspace*{5mm} \normalfont
Evolutionary algorithm is a heautric optimization based on population which is inspired by biological evolution. Evolution algorithm is applied to various problems, as it does not need any complex assumptions. Evolutionary algorithms have been widely applied to engineering, bibliography, economy, gene engineering and social science, etc.

Estimation of distribution algorithm is a kind of fresh evolution algorithm. Unlike traditional evolutionary algorithms, there is no crossover and mutation operations. Generally, estimation of distribution algorithm consists of three steps, modeling, sampling and selection. Sampling is a crucial step to estimation of distribution algorithm, as it is related to whether to generate more promising offspring population. The promising offspring population is significant to the final solutions.

Differential evolution has attracted many researchers since proposed in 1995. Differential is kind of simple but effective stochastic optimization algorithm. Due to the advantages of differential evolution, it has been widely utilized in different fields. Differential evolution has
